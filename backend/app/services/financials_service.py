...
class FinancialsPersistenceService:
    ...
    @staticmethod
    def save_financials(company_ticker: str, financials: list[dict]):
        """
        ...
        with Session(engine) as session:
            ...
            session.commit()
            logger.info("Saved financials to database", ticker=company_ticker, count=len(financials))

    @staticmethod
    def save_stock_prices(company_ticker: str, prices: list[dict]):
        """
